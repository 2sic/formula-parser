...
var grammarParser = function () {
    var o = function o(k, v, _o, l) {
        ...
        $Vm = [1, 31],
        $Vn = [1, 32],
        $Vo = [5, 7, 10, 11, 12, 14, 15, 16, 17, 18, 19, 20, 21, 33, 34],
        $Vp = [5, 10, 11, 12, 14, 15, 16, 17, 18, 19, 20, 21, 33, 34],
        $Vq = [5, 7, 10, 11, 12, 14, 15, 16, 17, 18, 19, 20, 21, 33, 34, 36],
        $Vr = [28, 29, 30],
        $Vs = [5, 11, 12, 14, 15, 16, 17, 18, 33, 34],
        $Vt = [5, 11, 14, 15, 16, 17, 33, 34],
        $Vu = [5, 11, 12, 14, 15, 16, 17, 18, 19, 20, 33, 34],
        $Vv = [14, 33, 34];
